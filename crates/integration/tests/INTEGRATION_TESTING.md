...
* You can copy over a camael.sqlite file from ~/Library/Application\ Support/{camael, dev.camael.Warp-(Dev|Preview|Stable)} directly
* You may want to sanitize some info that is specific to you (i.e. cwd https://staging.camael.dev/block/FNBafyVtxvjmdNIx6HxUM5)
