    ...
    let get_started = FeatureSectionData {
        ...
        items: vec![
            ...
            FeatureItem::new(
                ...
                "Access all of Camael via the keyboard.",
                Tip::Action(TipAction::CommandPalette),
                ctx,
            ),
            FeatureItem::new(
                "Set your theme",
                "Make Camael your own by choosing a theme.",
    ...
    let advanced_setup = ContentSectionData {
        ...
        items: vec![
            ContentItem {
                ...
                description: "Set up Camael to honor your PS1 setting",
                url: "https://docs.warp.dev/terminal/appearance/prompt",
                button_label: "View documentation",
            },
            ContentItem {
                title: "Integrate Camael with your IDE",
                description: "Configure Camael to launch from your most used development tools",
                url: "https://docs.warp.dev/terminal/integrations-and-plugins",
                button_label: "View documentation",
            },
            ContentItem {
                title: "How Camael uses Camael",
                description: "Learn how Camael's engineering team uses their favorite features",
