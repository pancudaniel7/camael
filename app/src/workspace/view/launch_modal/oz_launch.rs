    ...
    fn title(&self) -> &'static str {
        match self {
            ...
            OzLaunchSlide::LaunchCredits => {
                "1,000 free cloud agent credits when you upgrade to Camael Build"
            }
        }
    }
    ...
    fn content(&self) -> &'static str {
        match self {
            ...
            OzLaunchSlide::AgentManagement => {
                "View all of your agents across local and cloud sessions in the Camael app or at [oz.warp.dev](https://oz.warp.dev). Join live agent sessions, continue tasks locally, and steer agents with one click."
            }
            OzLaunchSlide::LaunchCredits => {
                "Upgrade to Build this month and receive 1,000 extra credits to try using Oz. Credits are only eligible for Oz runs in Camael-hosted cloud environments."
            }
        }
    }
