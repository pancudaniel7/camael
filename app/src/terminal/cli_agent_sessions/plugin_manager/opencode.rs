...
static INSTALL_INSTRUCTIONS: LazyLock<PluginInstructions> = LazyLock::new(|| {
    PluginInstructions {
        title: "Install Camael Plugin for OpenCode",
        subtitle:
            "Add the Camael plugin to your OpenCode configuration, then restart OpenCode.",
        steps: &[
...
static UPDATE_INSTRUCTIONS: LazyLock<PluginInstructions> = LazyLock::new(|| {
    PluginInstructions {
        title: "Update Camael Plugin for OpenCode",
