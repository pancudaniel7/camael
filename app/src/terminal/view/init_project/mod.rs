...
const ONBOARDING_TEXT: &str = "Great - let's begin setting up this project! Would you like to give me permission to index this codebase? It allows me to quickly understand context and provide more targeted solutions when working in this codebase. No code is stored on Camael servers.";
    ...
    fn render_project_rules(&self, app: &AppContext) -> Box<dyn Element> {
        ...
        match &step.status {
            ...
            InitStepStatus::Ready(_) => {
                ...
                Self::render_ready_with_buttons(
                    action_view,
                    "Would you like to create an AGENTS.md file? Camael can create one for you with project specific rules, context, and conventions inferred from your codebase. The agent will use this context as it codes.",
                    app,
                )
            }
            InitStepStatus::Running => {
