...
const TITLE_TEXT: &str = "Sharing in Camael Drive";
const BODY_TEXT: &[&str] = &[
    "You can now share drive objects, in Camael or on the web, with anyone - Camael user or not. Click Share in the Camael Drive menu or the pane header to share via link or email.",
