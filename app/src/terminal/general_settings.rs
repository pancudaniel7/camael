...
define_settings_group!(GeneralSettings, settings: [
    show_warning_before_quitting: ShowWarningBeforeQuitting {
        ...
        description: "Whether to show a warning dialog before quitting Camael.",
    },
    quit_on_last_window_closed: QuitOnLastWindowClosed {
        ...
        description: "Whether to quit Camael when the last window is closed.",
    },
    restore_session: RestoreSession {
        ...
        description: "Whether to restore the previous session when Camael starts up.",
    },
    add_app_as_login_item: LoginItem {
        ...
        description: "Whether to launch Camael automatically when you log in.",
    },
