...
impl AIDocumentView {
        ...
        match save_status {
            AIDocumentSaveStatus::NotSaved => {
                ...
                let tooltip = ui_builder
                    .tool_tip("Save and auto-sync this plan to your Camael Drive".to_string())
                    .build()
                    .finish();
            ...
            AIDocumentSaveStatus::Saved => {
                ...
                let ui_builder = appearance.ui_builder().clone();
                let tooltip_text =
                    "This plan is synced to your Camael Drive and will auto save any edits you make."
                        .to_string();
    ...
    fn create_warp_drive_notebook(&self, ctx: &mut ViewContext<Self>) {
        ...
        if !success {
            log::error!("Failed to create Camael Drive notebook");
        }
    }
