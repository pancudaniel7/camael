...
const TITLE_NEW_USERS: &str = "Help improve Camael.";
const DESCRIPTION: &str = "We may collect certain console interactions to improve Camael's AI capabilities. You can opt out any time.";
