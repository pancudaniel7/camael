...
const SSH_EXTENSION_INSTALL_MODE_DESCRIPTION: &str =
    "Controls the installation behavior for Camael's SSH extension when a remote host doesn't have it installed.";
    ...
    fn render_top_of_page(&self, appearance: &Appearance, _app: &AppContext) -> Box<dyn Element> {
        let warpify_description = vec![
            FormattedTextFragment::plain_text(
                "Configure whether Camael attempts to “Warpify” (add support for blocks, \
