...
static SAFE_MODE_DESCRIPTION: LazyLock<&'static str> = LazyLock::new(|| {
    "When this setting is enabled, Camael will scan blocks, the contents of \
        Camael Drive objects, and Oz prompts for potential sensitive \
...
const TELEMETRY_TITLE: &str = "Help improve Camael";
const TELEMETRY_DESCRIPTION: &str =
    "App analytics help us make the product better for you. We may collect \
    certain console interactions to improve Camael's AI capabilities.";
...
const DATA_MANAGEMENT_DESCRIPTION: &str =
    "At any time, you may choose to delete your Camael account permanently. \
    You will no longer be able to use Camael.";
const DATA_MANAGEMENT_LINK_TEXT: &str = "Visit the data management page";

const PRIVACY_POLICY_TITLE: &str = "Privacy policy";
const PRIVACY_POLICY_LINK_TEXT: &str = "Read Camael's privacy policy";
    ...
    fn render(
        ...
        column.add_child(
            Align::new(
                ui_builder
                    .link(
                        "Read more about Camael's use of data".into(),
                ...
                ui_builder
                    .paragraph(
                        if is_checked {
                            ...
                            for product functionality, and Camael will not use it for analytics."
                        } else {
            ...
            .with_child(
                ui_builder
                    .paragraph(
                        ...
                        from Camael to external servers to ensure you feel comfortable that your \
