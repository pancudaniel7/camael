...
impl ExternalEditorView {
    ...
    fn init_editor_dropdown(
        ...
        items.push(DropdownItem::new("Camael", make_action(EditorChoice::Camael)));
        ...
        match editor_to_open_files {
            ...
            EditorChoice::Camael => dropdown.set_selected_by_name("Camael", ctx),
...
impl View for ExternalEditorView {
    ...
    fn render(&self, app: &warpui::AppContext) -> Box<dyn warpui::Element> {
        ...
        let default_layout = render_dropdown_item(
            appearance,
            "Choose a layout to open files in Camael",
            None,
            None,
            LocalOnlyIconState::for_setting(
        ...
        column.add_child(render_body_item::<ExternalEditorAction>(
            "Open Markdown files in Camael's Markdown Viewer by default".to_string(),
            Some(AdditionalInfo {
