        ...
        if !has_admin_permissions && auto_reload_enabled {
            ...
            let description_text = match configured_auto_reload_option {
                Some(option) => {
                    ...
                    format!(
                        "Your admin has enabled auto-reload for add-on credits. When your personal add-on credit balance runs low, Camael will automatically purchase {credits} credits for {price} and add them to your balance."
                    )
                }
                None => {
                    "Your admin has enabled auto-reload for add-on credits. When your personal add-on credit balance runs low, Camael will automatically purchase add-on credits and add them to your balance.".to_string()
                }
            };
