...
```
CONTAINER_NAME="camael-client-linux-dev"
...
# container. This can be the `camael` repository or some parent
...
You should be able to SSH into the container and build and run camael without any additional setup (dev account password is "password"):
