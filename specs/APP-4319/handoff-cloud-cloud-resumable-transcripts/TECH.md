...
Targeted checks:
- `cargo nextest run -p camael terminal::view::shared_session::view_impl_test terminal::view_test`
- `cargo nextest run -p camael pane_group::mod_tests ai::agent_conversations_model_tests`
