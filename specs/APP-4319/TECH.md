...
The server follow-up API is `POST /api/v1/agent/runs/{runId}/followups` with a JSON body containing `message`. The server route and request type are in the server worktree at `/Users/zachbai/.camael-dev/worktrees/camael-server/cloud-agent-task-name/public_api/openapi.yaml:644`, `/Users/zachbai/.camael-dev/worktrees/camael-server/cloud-agent-task-name/router/handlers/public_api/agent_webhooks.go:181`, `/Users/zachbai/.camael-dev/worktrees/camael-server/cloud-agent-task-name/router/handlers/public_api/agent_webhooks.go:608`, and `/Users/zachbai/.camael-dev/worktrees/camael-server/cloud-agent-task-name/public_api/types/types.gen.go:1225`.
...
`cargo nextest run -p camael server::server_api::ai::tests::build_run_followup_url_routes_to_run_followups server::server_api::ai::tests::serialize_run_followup_request ai::ambient_agents::spawn::tests`
`cargo nextest run -p camael ai::agent_conversations_model::tests ai::conversation_details_panel::tests`
`cargo check -p camael --features handoff_cloud_cloud`
