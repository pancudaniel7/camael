...
2. Warp writes the default template to `~/.camael/tab_configs/my_tab_config.toml` and opens it in the user's configured editor.
...
- Oz generates a valid `.toml` file and writes it to `~/.camael/tab_configs/`.
