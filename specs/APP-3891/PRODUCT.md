...
The first approach implemented was to decode each attached image from base64, write it to a temp file on disk (e.g. `/var/folders/.../camael-cli-image-1776199745040956000.png`), and prepend a `[Attached images: /path/to/file]` block to the prompt text.
