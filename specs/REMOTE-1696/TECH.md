...
The named-agent API reference is in `../camael-server/public_api/openapi.yaml`:
- `POST /agent/identities` and `GET /agent/identities` at `../camael-server/public_api/openapi.yaml (2709-2781)`.
- `GET /agent/identities/{uid}`, `PUT /agent/identities/{uid}`, and `DELETE /agent/identities/{uid}` at `../camael-server/public_api/openapi.yaml (2783-2917)`.
- `CreateAgentRequest`, `UpdateAgentRequest`, `AgentResponse`, and `ListAgentsResponse` at `../camael-server/public_api/openapi.yaml (5399-5539)`.
