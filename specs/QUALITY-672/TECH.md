...
PR: [#10777](https://github.com/warpdotdev/camael/pull/10777)
## Context
...
### Presubmit
`cargo fmt`, `cargo build -p camael`, `cargo nextest run -p camael orchestration_pin_model`, `cargo clippy -p camael --tests --all-features`.
