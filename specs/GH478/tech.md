...
Issue: https://github.com/warpdotdev/camael/issues/478
Related: https://github.com/warpdotdev/camael/issues/2618
...
non-synced file (`~/.camael/redaction_salt`, mode `0600`), and never
leaves the machine.
...
/// `~/.camael/redaction_salt` (generated on first launch, mode 0600,
...
- The redaction-salt file (`~/.camael/redaction_salt`) is created with
