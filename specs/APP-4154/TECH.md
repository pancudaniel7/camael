...
4. Tick the row.
5. Validate your slice: `cargo fmt` + `cargo check -p camael --bin camael --features gui,cocoa_sentry`.
...
- `cargo fmt` and `cargo check -p camael --bin camael --features gui,cocoa_sentry` on macOS, matching PR #560.
