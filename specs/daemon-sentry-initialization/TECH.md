...
2. Connected from Warp client → daemon crashed → verified event appeared in Sentry (`camael-client-local` project) within seconds.
3. Confirmed Sentry event contains:
   ...
   - `camael.client_type: camael-cli` tag.
