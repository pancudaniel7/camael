...
[Issue #10207](https://github.com/warpdotdev/camael/issues/10207): Project Explorer
...
([comment](https://github.com/warpdotdev/camael/pull/10490#issuecomment-4423492563)):
...
(`crates/ai/src/project_context/model.rs:298`), `camael::ai::outline::native`,
...
([comment](https://github.com/warpdotdev/camael/pull/10490#issuecomment-4427103160)),
...
- Manual: use the existing fixture at
  `~/code-fixtures/camael-10207-large-repo` (150,001 files). Build with
  `./script/run --dont-open` and `open -a target/debug/bundle/osx/WarpOss.app
  ~/code-fixtures/camael-10207-large-repo`. Verify:
  1. `~/Library/Logs/camael-oss.log` contains the "indexed in degraded
