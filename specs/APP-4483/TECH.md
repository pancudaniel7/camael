...
- `cargo test -p camael --lib terminal::view::shared_session::view_impl_tests`
- `cargo test -p camael --lib terminal::view::shared_session::conversation_ended_tombstone_view_tests`
- `cargo test -p camael --lib terminal::view::shared_session::cloud_conversation_continuation`
