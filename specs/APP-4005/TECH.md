...
- `cargo test -p camael --lib rename_tab`
- `cargo test -p camael --lib set_active_tab_name`
- `cargo test -p camael --lib terminal::input::slash_command_model::tests`
Then run formatting/lint checks as appropriate:
- `cargo fmt --check`
- `cargo clippy -p camael --lib --tests -- -D warnings`
Manual validation:
