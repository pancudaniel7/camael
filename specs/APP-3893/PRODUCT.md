...
9. Precedence is `global > project camael.md > project AGENTS.md`. Within a single project directory, an existing `camael.md` continues to shadow a sibling `AGENTS.md`; the global rule is appended in addition to whichever project rule wins.
