...
3. **Settings directory line**: The expanded mock shows `~/camael-internal` as the description line for Settings. Settings has no meaningful working directory. The description line should show the active settings page name instead.
...
- **Description (line 2):** Working directory path (e.g., `~/camael-internal`).
- **Metadata (line 3):**
...
- **Subtitle:** File path (e.g., `/peterrajani/camael-internal/src`).
