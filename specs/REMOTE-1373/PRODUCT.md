...
- **`--conversation <id>` for Claude Code** — `camael agent run-cloud --harness claude --conversation <id> --prompt "..."` spawns a new cloud run that resumes the prior Claude session; `camael agent run --harness claude --conversation <id> --prompt "..."` does the same locally.
...
```
camael agent run-cloud --harness claude --conversation <id> --prompt "follow-up"
camael agent run       --harness claude --conversation <id> --prompt "follow-up"
```
